# Hubert Jackowski
# plus za dobrą dokumentację listy
# potrzebna poprawa parametru right podwykresów
# poprawa zabezpieczeń programu np.
# "File "C:\Users\jakub\PycharmProjects\L12-13\l12.py", line 55, in <module>
#    data = GetDataFormExcel(pathlib.Path.cwd() / "dane_g3.xlsx", 1)
#           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#  File "C:\Users\jakub\PycharmProjects\L12-13\l12.py", line 53, in GetDataFormExcel
